...
# Load car mesh from file and create car shapes from it
...
# Place the planes above the city intersection
new Plane at (9,0,100), facing toward ego, with color (0.255, 0, 0)  # Red plane
new Plane at (14,0,50), facing directly toward ego, with color (0, 0, 0.855)  # Blue plane

# Place the ball above the city intersection
ball = new Ball at (0,0,80)
